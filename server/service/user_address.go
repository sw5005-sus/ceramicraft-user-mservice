...
func (u *UserAddressServiceImpl) CreateUserAddress(ctx context.Context, address *data.UserAddressVO) (*data.UserAddressVO, error) {
	addrModel := &model.UserAddress{
		...
		Country:      strictSanitization(address.Country),
		Province:     strictSanitization(address.Province),
		City:         strictSanitization(address.City),
		Detail:       strictSanitization(address.Detail),
		FirstName:    strictSanitization(address.FirstName),
		LastName:     strictSanitization(address.LastName),
